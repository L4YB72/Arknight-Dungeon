...
void load_game_resources() {
    ...
    B2_idle_right.add_image(_T("Image/B2/idle/B2_idle_%d.png"), 12,100, 100, 1); // 加载B2右待机图片
    flip_Atlas(B2_idle_right, B2_idle_left); // 翻转B2右待机图片为左待机

    B2_move_right.add_image(_T("Image/B2/move/B2_move_%d.png"), 12, 100, 100, 1); // 加载B2右移动图片
    flip_Atlas(B2_move_right, B2_move_left); // 翻转B2右移动图片为左移动
        
    B2_right_attack.add_image(_T("Image/B2/attack/B2_attack_%d.png"), 15, 100, 100,1); // 加载B2攻击图片
